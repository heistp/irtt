...
3. Use `build.sh` to build during development, which helps with development
   related tasks. For example, `build.sh min linux-amd64` would compile a

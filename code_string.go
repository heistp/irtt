...
const (
	_Code_name_0 = ""
...
var (
	_Code_index_0 = [...]uint16{0, 17, 36, 62, 85, 109, 120, 132, 145, 164, 183, 195, 211, 222, 234, 248, 267, 284, 301, 319, 343, 356, 371, 381, 398, 406, 413, 431, 451, 469, 488}

...
func hostUsage() {
	...
	printf("addresses must be surrounded by brackets if a port is included, a and")
	printf("may include a zone after the % character. Examples:")
	printf("")
	printf("IPv4 IP:              192.168.1.10")
	printf("IPv6 IP:              ::1")
	printf("IPv6 IP/port:         [fe80::426c:8fff:fe13:9feb%%en0]:2112")
	printf("IPv4/6 hostname:      localhost")
	printf("IPv4/6 hostname/port: irtt.example.org:2112")
	printf("")
